...
// CodiceFiscale.cpp: definisce i comportamenti delle classi per l'applicazione.
//
...
BEGIN_MESSAGE_MAP(CCodiceFiscaleApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Costruzione di CCodiceFiscaleApp

CCodiceFiscaleApp::CCodiceFiscaleApp()
{
...
// Unico oggetto CCodiceFiscaleApp

CCodiceFiscaleApp theApp;


// Inizializzazione di CCodiceFiscaleApp

BOOL CCodiceFiscaleApp::InitInstance()
{
